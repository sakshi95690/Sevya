...
export const WorkflowsView: React.FC<{ templeId?: string }> = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-amber-600 to-orange-600 rounded-2xl p-6 text-white shadow-lg flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <Cpu className="w-6 h-6" />
            <h1 className="text-2xl font-bold tracking-tight">Cloud Flow Automation</h1>
          </div>
          <p className="text-amber-100 text-sm max-w-2xl">
            Centralized production workflow engine managing event orchestration, multi-channel notifications, approvals, task scheduling, and external integrations.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <button
            onClick={() => loadData()}
            className="flex items-center gap-2 px-3 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-sm font-medium transition"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white text-amber-900 hover:bg-amber-50 rounded-lg text-sm font-semibold shadow transition"
          >
