...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  const renderNavContent = () => (
    <div className="flex flex-col h-full justify-between">
      ...
      <div className="pb-3.5 mb-2 border-b border-slate-100 dark:border-slate-800">
      ...
      <div className="flex-1 overflow-y-auto pr-1 py-1 space-y-4 max-h-[calc(100vh-16rem)]">
        {categories.map((cat) => {
